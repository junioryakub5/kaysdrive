...
export default function MyCars() {
    ...
    const openModal = (car?: Car) => {
        if (car) {
            ...
            setEditingCar(null);
            setForm({
                title: '', price: 0, priceType: 'fixed', status: 'sale',
        ...
        <div>
            <div className="page-header flex justify-between items-center">
                <div>
                    ...
                    <p className="page-subtitle">Manage your car listings</p>
                </div>
                                    ...
                                    <tr key={car.id}>
                                        <td>
                                            <div className="flex items-center gap-2">
                                                <img src={car.images[0] || 'https://via.placeholder.com/40'} alt={car.title} className="avatar" style={{ borderRadius: '0.5rem' }} />
                                                <div>
                                        ...
                                        <td>
                                            <span className={`badge ${car.isPublished ? 'badge-success' : 'badge-warning'}`}>
                                                {car.isPublished ? 'Published' : 'Pending Review'}
                                            </span>
                                        </td>
                                        <td>
